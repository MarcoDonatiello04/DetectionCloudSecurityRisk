...
from src.core.api3_bopla.models import PropertyInventory
...
""",
    ...
    mock_traffic = [{"method": "GET", "path": "/users", "response": {"id": 1, "salary": 1000}}]

    inventory = PropertyDiscoveryEngine.discover_properties(
        repo_path=str(tmp_path), openapi_spec=mock_openapi, runtime_traffic=mock_traffic
    )
