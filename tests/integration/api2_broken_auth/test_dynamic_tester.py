...
from src.core.api2_broken_auth.dynamic_tester import (
    DynamicTester,
...
async def test_t14_infinite_lifetime_refresh_token_pass():
    ...
    from src.core.api2_broken_auth.dynamic_tester import base64url_encode
...
async def test_run_function():
    ...
    with patch(
        "src.core.api2_broken_auth.dynamic_tester.DynamicTester._get_client",
