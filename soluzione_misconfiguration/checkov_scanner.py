...
from soluzione_api.src.models.finding import Finding, FindingSource, FindingCategory, Severity, CodeLocation
from soluzione_api.src.interfaces.scanner import ScannerInterface

class CheckovScanner(ScannerInterface):
...
def run_checkov(target_dir=".") -> List[Finding]:
    return CheckovScanner().scan(target_dir)
