...
class RiskCard(QFrame):
    ...
    def __init__(self, title: str, value: str, color_hex: str = "#38bdf8", parent=None):
        ...
        self.title_label.setStyleSheet("color: #9ca3af; letter-spacing: 1px;")
        layout.addWidget(self.title_label)

        # Label del Valore Principale
        self.value_label = QLabel(value)
        self.value_label.setFont(QFont("Outfit", 26, QFont.ExtraBold))
        self.value_label.setStyleSheet(f"color: {color_hex};")
        layout.addWidget(self.value_label)

        # Label del Sottotitolo (opzionale)
    ...
    def set_subtitle(self, text: str):
        """
        Imposta il testo di sotto-riepilogo.
        """
