...
from src.core.api4_resource_consumption.layers.layer2_config import (
    analyze_configs as analyze_config,
)
from src.core.api4_resource_consumption.layers.layer3_openapi import analyze_openapi
from src.core.api4_resource_consumption.models import (
...
class Api4ResourceConsumptionDetector(IVulnerabilityDetector):
    ...
    def detector_id(self) -> str:
        return "API4_RESOURCE_CONSUMPTION"

    @property
    def name(self) -> str:
        return "Unrestricted Resource Consumption Detector"
