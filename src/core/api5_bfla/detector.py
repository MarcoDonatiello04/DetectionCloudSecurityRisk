...
from src.core.api5_bfla.layers.layer1_ast import (
    analyze_ast_with_endpoints,
)
from src.core.api5_bfla.layers.layer2_config import (
    analyze_configs as analyze_config,
)
from src.core.api5_bfla.layers.layer3_openapi import analyze_openapi
from src.core.api5_bfla.models import (
...
class Api5BflaDetector(IVulnerabilityDetector):
    ...
    @property
    def name(self) -> str:
        return "Broken Function Level Authorization Detector"
