...
from . import semgrep_runner, normalizer
from .layers import layer3_openapi
from .models import SsrfReport, SsrfFinding
...
def analyze(
    ...
    if openapi_spec is not None:
        openapi_findings = layer3_openapi.analyze_openapi(
            openapi_spec, enrich_spec=enrich_spec
        )
