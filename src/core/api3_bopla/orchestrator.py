    ...
    def run_assessment(
        ...
        try:
            if headers_matrix and evidences:
                ...
                logger.info("Avvio Dynamic Property Authorization Testing...")
        ...
        logger.info(f"Report BOPLA generati con successo in: {output_dir}")
