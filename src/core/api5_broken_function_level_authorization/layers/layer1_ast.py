...
from src.core.api5_broken_function_level_authorization.rules.privileged_endpoint_no_role_check import PrivilegedEndpointNoRoleCheckRule
from src.core.api5_broken_function_level_authorization.rules.auth_without_authz import AuthWithoutAuthzRule
from src.core.api5_broken_function_level_authorization.rules.http_method_override import HTTPMethodOverrideRule
from src.core.api5_broken_function_level_authorization.rules.admin_path_exposure import AdminPathExposureRule
...
def _extract_endpoints_python(root: Node) -> list[str]:
    from src.core.api5_broken_function_level_authorization.rules.admin_path_exposure import _get_blueprint_info
