import pytest
from src.core.api5_broken_function_level_authorization.layers.layer3_openapi import analyze_openapi, detect_spec_version
...
def test_no_finding_on_protected_endpoint():
    spec = {
        ...
        "paths": {
            "/admin/users": {
                "delete": {"summary": "Delete all users"}
            }
        }
    }
    findings = analyze_openapi(spec)
