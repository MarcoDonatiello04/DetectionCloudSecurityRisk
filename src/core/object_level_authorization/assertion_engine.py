...
from src.core.object_level_authorization.role_matrix import AccessControlMatrix
...
class APIAssertionEngine:
    ...
    ERROR_KEYWORDS = [
        r"access denied", r"unauthorized", r"forbidden", r"non autorizzato", 
        r"accesso negato", r"permission denied", r"error_code", r"invalid_user"
    ]
    ...
    def evaluate_bola_assertion(
        ...
        technical_success = (
            not http_status_assertion and 
            not content_keyword_assertion and 
            structural_similarity_assertion
        )
