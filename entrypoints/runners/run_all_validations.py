...
def main():
    ...
    steps = [
        ...
        (
            ...
            [sys.executable, "src/core/broken_function_level_authorization/tests/validate_ground_truth.py"]
        ),
        (
            "API4 Unrestricted Resource Consumption Ground Truth",
            [sys.executable, "src/core/unrestricted_resource_consumption/tests/validate_ground_truth.py"]
        ),
    ]
