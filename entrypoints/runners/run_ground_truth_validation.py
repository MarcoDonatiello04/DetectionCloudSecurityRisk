...
VULN_APP_DIR = PROJECT_ROOT / "data/test_targets/broken_authentication" / "vulnerable_app"
SECURE_APP_DIR = PROJECT_ROOT / "data/test_targets/broken_authentication" / "secure_app"
